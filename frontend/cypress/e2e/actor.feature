...
Scenario: Användaren hamnar på sidan med skådespelare.
  Given Användaren är på hemsidan och det finns en knapp List of Actors and Actresses.
  When Användaren klickar på knappen.
  Then Användaren hamnar på en sida med en titel "Actors and Actresses".
